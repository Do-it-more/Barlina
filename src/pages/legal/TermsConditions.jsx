        ...
        },
        {
            ...
            content: (
                <ul className="list-disc pl-5 mt-2 space-y-2">
                    <li><strong>&ldquo;Payment Instrument&rdquo;</strong> includes credit card, debit card, bank account, prepaid payment instrument, Unified Payment Interface (UPI), Immediate Payment Service (IMPS) or any other methods of payments which shall be developed or added or deployed by banks and financial institutions from time to time.</li>
                    <li><strong>&ldquo;Platform&rdquo;</strong> refers to the website or platform where the Merchant offers its products or services and where the Transaction may be initiated.</li>
                    <li><strong>&ldquo;Transaction&rdquo;</strong> shall refer to the order or request placed by the User with the Merchant to purchase the products and/or services listed on the Platform by paying the Transaction Amount to the Merchant;</li>
                    <li><strong>&ldquo;Transaction Amount&rdquo;</strong> shall mean the amount paid by the User in connection with a Transaction; and</li>
                    <li><strong>&ldquo;User/Users&rdquo;</strong>, means any person availing the products and/or services offered on the Platform;</li>
                    <li><strong>&ldquo;Website&rdquo;</strong> shall mean www.instamojo.com or the mobile application</li>
                </ul>
            )
        },
        {
        ...
        },
        {
            ...
            content: (
                <div>
                    ...
                    <p className="mt-4">We may accept, reject, or remove reviews in our sole discretion. We have absolutely no obligation to screen reviews or to delete reviews, even if anyone considers reviews objectionable or inaccurate. Reviews are not endorsed by us, and do not necessarily represent our opinions or the views of any of our affiliates or partners. We do not assume liability for any review or for any claims, liabilities, or losses resulting from any review. By posting a review, you hereby grant to us a perpetual, non-exclusive, worldwide, royalty-free, fully paid, assignable, and sublicensable right and license to reproduce, modify, translate, transmit by any means, display, perform and/or distribute all content relating to reviews.</p>
                </div>
            )
        },
        {
            title: "GOVERNING LAWS & DISPUTE RESOLUTION",
            content: (
                <div>
                    <p className="mb-2">Please note that these terms of use, their subject matter and their formation, are governed by the laws of India. You and we both agree that the courts of India will have exclusive jurisdiction over any dispute.</p>
                    <p className="mb-2">Any dispute or claim arising out of or in connection with or relating to these Terms or their breach, termination or invalidity hereof (&ldquo;Dispute&rdquo;) shall be referred to and finally resolved by arbitration in Bengaluru in accordance with the Arbitration and Conciliation Act, 1996 for the time being in force, which rules are deemed to be incorporated by reference in this clause 12.2.</p>
                    <ul className="list-disc pl-5 space-y-2">
                        <li>Within 30 (thirty) days of the issue of a notice of Dispute, the parties shall mutually agree on the appointment of a sole arbitrator. If such mutual agreement is not arrived at within the aforesaid 30 (thirty) days&apos; period, the parties shall appoint such sole arbitrator in accordance with the Arbitration and Conciliation Act, 1996.</li>
                        <li>The seat of arbitration shall be India and the arbitration proceedings shall be conducted in the English language.</li>
                        <li>The parties shall keep the arbitration confidential and not disclose to any person, other than those necessary to the proceedings, any information, transcripts or award unless required to do so by law.</li>
                        <li>The decision of the arbitrator shall be final and binding on all the parties hereto.</li>
                        <li>The parties hereto agree that their consent for resolution of Dispute through arbitration shall not preclude or restrain either of them from seeking suitable injunctive relief in appropriate circumstances from courts in Bengaluru.</li>
                        <li>The cost of arbitration shall be borne in the manner and by a party as determined by the arbitrators. In the meantime, each party shall bear its own cost for the arbitration which shall be reimbursed as per the directions in the arbitral award.</li>
                    </ul>
                </div>
            )
        },
        ...
        },
        {
            ...
            content: (
                <div className="space-y-3">
                    ...
                    <p>The content on our Platform is provided for general information only. The information provided does not to amount to advice from us in any manner and should not be relied upon. Where our Platform contains links to other websites and resources provided by third parties, these links are provided for your information only. Such links should not be interpreted as approval by us of those linked websites or information you may obtain from them.</p>
                    <p>This Platform includes information and materials uploaded by other Users of the Platform. You understand that such information and materials have not been verified or approved by us. The views expressed by other Users on our Platform do not represent our views or values.</p>
